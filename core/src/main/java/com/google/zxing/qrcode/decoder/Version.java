...
public final class Version {
	...
	public static Version getVersionForNumber(int versionNumber) {
		...
		case 1:
			return new Version(versionNumber, new int[] {}, new ECBlocks(7,
					new ECB(1, 19)), new ECBlocks(10, new ECB(1, 16)),
					new ECBlocks(13, new ECB(1, 13)), new ECBlocks(17, new ECB(
							1, 9)));
		case 2:
			return new Version(versionNumber, new int[] { 6, 18 },
					new ECBlocks(10, new ECB(1, 34)), new ECBlocks(16, new ECB(
							1, 28)), new ECBlocks(22, new ECB(1, 22)),
							new ECBlocks(28, new ECB(1, 16)));
		case 3:
			return

					new Version(versionNumber, new int[] { 6, 22 }, new ECBlocks(15,
							new ECB(1, 55)), new ECBlocks(26, new ECB(1, 44)),
							new ECBlocks(18, new ECB(2, 17)), new ECBlocks(22, new ECB(
									2, 13)));
		case 4:
			return

					new Version(versionNumber, new int[] { 6, 26 }, new ECBlocks(20,
							new ECB(1, 80)), new ECBlocks(18, new ECB(2, 32)),
							new ECBlocks(26, new ECB(2, 24)), new ECBlocks(16, new ECB(
									4, 9)));
		case 5:
			return

					new Version(versionNumber, new int[] { 6, 30 }, new ECBlocks(26,
							new ECB(1, 108)), new ECBlocks(24, new ECB(2, 43)),
							new ECBlocks(18, new ECB(2, 15), new ECB(2, 16)),
							new ECBlocks(22, new ECB(2, 11), new ECB(2, 12)));
		case 6:
			return

					new Version(versionNumber, new int[] { 6, 34 }, new ECBlocks(18,
							new ECB(2, 68)), new ECBlocks(16, new ECB(4, 27)),
							new ECBlocks(24, new ECB(4, 19)), new ECBlocks(28, new ECB(
									4, 15)));
		case 7:
			return

					new Version(versionNumber, new int[] { 6, 22, 38 }, new ECBlocks(
							20, new ECB(2, 78)), new ECBlocks(18, new ECB(4, 31)),
							new ECBlocks(18, new ECB(2, 14), new ECB(4, 15)),
							new ECBlocks(26, new ECB(4, 13), new ECB(1, 14)));
		case 8:
			return

					new Version(versionNumber, new int[] { 6, 24, 42 }, new ECBlocks(
							24, new ECB(2, 97)), new ECBlocks(22, new ECB(2, 38),
									new ECB(2, 39)), new ECBlocks(22, new ECB(4, 18), new ECB(
											2, 19)), new ECBlocks(26, new ECB(4, 14), new ECB(2, 15)));
		case 9:
			return

					new Version(versionNumber, new int[] { 6, 26, 46 }, new ECBlocks(
							30, new ECB(2, 116)), new ECBlocks(22, new ECB(3, 36),
									new ECB(2, 37)), new ECBlocks(20, new ECB(4, 16), new ECB(
											4, 17)), new ECBlocks(24, new ECB(4, 12), new ECB(4, 13)));
		case 10:
			return

					new Version(versionNumber, new int[] { 6, 28, 50 }, new ECBlocks(
							18, new ECB(2, 68), new ECB(2, 69)), new ECBlocks(26,
									new ECB(4, 43), new ECB(1, 44)), new ECBlocks(24, new ECB(
											6, 19), new ECB(2, 20)), new ECBlocks(28, new ECB(6, 15),
													new ECB(2, 16)));
		case 11:
			return

					new Version(versionNumber, new int[] { 6, 30, 54 }, new ECBlocks(
							20, new ECB(4, 81)), new ECBlocks(30, new ECB(1, 50),
									new ECB(4, 51)), new ECBlocks(28, new ECB(4, 22), new ECB(
											4, 23)), new ECBlocks(24, new ECB(3, 12), new ECB(8, 13)));
		case 12:
			return

					new Version(versionNumber, new int[] { 6, 32, 58 }, new ECBlocks(
							24, new ECB(2, 92), new ECB(2, 93)), new ECBlocks(22,
									new ECB(6, 36), new ECB(2, 37)), new ECBlocks(26, new ECB(
											4, 20), new ECB(6, 21)), new ECBlocks(28, new ECB(7, 14),
													new ECB(4, 15)));
		case 13:
			return

					new Version(versionNumber, new int[] { 6, 34, 62 }, new ECBlocks(
							26, new ECB(4, 107)), new ECBlocks(22, new ECB(8, 37),
									new ECB(1, 38)), new ECBlocks(24, new ECB(8, 20), new ECB(
											4, 21)), new ECBlocks(22, new ECB(12, 11), new ECB(4, 12)));
		case 14:
			return

					new Version(versionNumber, new int[] { 6, 26, 46, 66 },
		...
		case 15:
			return
					...
					new Version(versionNumber, new int[] { 6, 26, 48, 70 },
		...
		case 16:
			return
					...
					new Version(versionNumber, new int[] { 6, 26, 50, 74 },
		...
		case 17:
			return
					...
					new Version(versionNumber, new int[] { 6, 30, 54, 78 },
		...
		case 18:
			return
					...
					new Version(versionNumber, new int[] { 6, 30, 56, 82 },
		...
		case 19:
			return
					...
					new Version(versionNumber, new int[] { 6, 30, 58, 86 },
		...
		case 20:
			return
					...
					new Version(versionNumber, new int[] { 6, 34, 62, 90 },
		...
		case 21:
			return
					...
					new Version(versionNumber, new int[] { 6, 28, 50, 72, 94 },
							new ECBlocks(28, new ECB(4, 116), new ECB(4, 117)),
							new ECBlocks(26, new ECB(17, 42)), new ECBlocks(28,
									new ECB(17, 22), new ECB(6, 23)), new ECBlocks(30,
											new ECB(19, 16), new ECB(6, 17)));
		case 22:
			return

					new Version(versionNumber, new int[] { 6, 26, 50, 74, 98 },
							new ECBlocks(28, new ECB(2, 111), new ECB(7, 112)),
							new ECBlocks(28, new ECB(17, 46)), new ECBlocks(30,
									new ECB(7, 24), new ECB(16, 25)), new ECBlocks(24,
											new ECB(34, 13)));
		case 23:
			return

					new Version(versionNumber, new int[] { 6, 30, 54, 78, 102 },
		...
		case 24:
			return
					...
					new Version(versionNumber, new int[] { 6, 28, 54, 80, 106 },
		...
		case 25:
			return
					...
					new Version(versionNumber, new int[] { 6, 32, 58, 84, 110 },
		...
		case 26:
			return
					...
					new Version(versionNumber, new int[] { 6, 30, 58, 86, 114 },
		...
		case 27:
			return
					...
					new Version(versionNumber, new int[] { 6, 34, 62, 90, 118 },
		...
		case 28:
			return
					...
					new Version(versionNumber, new int[] { 6, 26, 50, 74, 98, 122 },
		...
		case 29:
			return
					...
					new Version(versionNumber, new int[] { 6, 30, 54, 78, 102, 126 },
		...
		case 30:
			return
					...
					new Version(versionNumber, new int[] { 6, 26, 52, 78, 104, 130 },
		...
		case 31:
			return
					...
					new Version(versionNumber, new int[] { 6, 30, 56, 82, 108, 134 },
		...
		case 32:
			return
					...
					new Version(versionNumber, new int[] { 6, 34, 60, 86, 112, 138 },
							new ECBlocks(30, new ECB(17, 115)), new ECBlocks(28,
									new ECB(10, 46), new ECB(23, 47)), new ECBlocks(30,
											new ECB(10, 24), new ECB(35, 25)), new ECBlocks(30,
													new ECB(19, 15), new ECB(35, 16)));
		case 33:
			return

					new Version(versionNumber, new int[] { 6, 30, 58, 86, 114, 142 },
		...
		case 34:
			return
					...
					new Version(versionNumber, new int[] { 6, 34, 62, 90, 118, 146 },
		...
		case 35:
			return
					...
					new Version(versionNumber,
							new int[] { 6, 30, 54, 78, 102, 126, 150 }, new ECBlocks(
									30, new ECB(12, 121), new ECB(7, 122)),
		...
		case 36:
			return
					...
					new Version(versionNumber,
							new int[] { 6, 24, 50, 76, 102, 128, 154 }, new ECBlocks(
									30, new ECB(6, 121), new ECB(14, 122)),
		...
		case 37:
			return
					...
					new Version(versionNumber,
							new int[] { 6, 28, 54, 80, 106, 132, 158 }, new ECBlocks(
									30, new ECB(17, 122), new ECB(4, 123)),
		...
		case 38:
			return
					...
					new Version(versionNumber,
							new int[] { 6, 32, 58, 84, 110, 136, 162 }, new ECBlocks(
									30, new ECB(4, 122), new ECB(18, 123)),
		...
		case 39:
			return
					...
					new Version(versionNumber,
							new int[] { 6, 26, 54, 82, 110, 138, 166 }, new ECBlocks(
									30, new ECB(20, 117), new ECB(4, 118)),
		...
		case 40:
			return
					...
					new Version(versionNumber,
							new int[] { 6, 30, 58, 86, 114, 142, 170 }, new ECBlocks(
									30, new ECB(19, 118), new ECB(6, 119)),
