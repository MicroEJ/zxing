...
public final class GenericGF {
	...
	public enum GenericGFTypes {QR_CODE_FIELD_256};

	public final static GenericGF getGenericGF(GenericGFTypes type){
		switch(type){
		case QR_CODE_FIELD_256:
			return  new GenericGF(0x011D, 256, 0); // x^8 + x^4 + x^3 + x^2 + 1
		default:
			return null;
